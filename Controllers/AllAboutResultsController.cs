    ...
    public class AllAboutResultsController : Controller
    {
        public IActionResult Index()
        {
            ...
            switch (day)
            {
                case "Monday":
                case "Tuesday":
                    HttpContext.Session.SetString("dayMsg", "The week just started! Stay focused, you have a lot of work to do this week!");
                    route = 1;
                    break;
                case "Wednesday":
                ...
                case "Friday":
                    ...
                    break;
                default:
                    HttpContext.Session.SetString("dayMsg", "Ahh, the weekend!");
                    route = 5;
                    break;
            }
            //route = 4;
